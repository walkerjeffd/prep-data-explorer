...
drop materialized view if exists odm2.prep_stations_basin cascade;
...
drop materialized view if exists odm2.prep_results_all cascade;
...
drop materialized view if exists odm2.prep_variables cascade;
...
drop materialized view if exists odm2.prep_results cascade;
